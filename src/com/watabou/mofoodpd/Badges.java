...
import com.watabou.mofoodpd.actors.mobs.Acidic;
import com.watabou.mofoodpd.actors.mobs.Albino;
import com.watabou.mofoodpd.actors.mobs.Bandit;
import com.watabou.mofoodpd.actors.mobs.Mob;
import com.watabou.mofoodpd.actors.mobs.Senior;
import com.watabou.mofoodpd.actors.mobs.Shielded;
import com.watabou.mofoodpd.items.Item;
import com.watabou.mofoodpd.items.bags.ScrollHolder;
import com.watabou.mofoodpd.items.bags.SeedPouch;
import com.watabou.mofoodpd.items.bags.WandHolster;
import com.watabou.mofoodpd.items.potions.Potion;
import com.watabou.mofoodpd.items.rings.Ring;
import com.watabou.mofoodpd.items.rings.RingOfHaggler;
...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1("10 enemies slain", 0), MONSTERS_SLAIN_2(
				...
				"All potions, scrolls, rings & wands identified", 35, true), BAG_BOUGHT_SEED_POUCH, BAG_BOUGHT_SCROLL_HOLDER, BAG_BOUGHT_WAND_HOLSTER, ALL_BAGS_BOUGHT(
				...
				"2000 games played", 63, true), HAPPY_END("Happy end", 38), SUPPORTER(
	...
	private static final String BADGES_FILE = "mofood-badges.dat";
